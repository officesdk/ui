...
Officesdk Design provides a comprehensive icon library with 66 icons organized into 8 categories. All icons are SVG-based React components that preserve their original dimensions and colors while allowing easy customization.
...
| `color` | `string` | - | Color override (SVG only, CSS color value) |
